              ...
              <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control @error('nama_peserta') is-invalid @enderror form-control-sm" id="name" name="nama_peserta" type="text" value="{{ $peserta->nama }}">
                    @error('nama_peserta')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control @error('kategori_usia') is-invalid @enderror form-control-sm" id="kategori_usia" name="kategori_usia" type="text" value="{{ $peserta->kategori_usia }}">
                    @error('kategori_usia')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input class="form-control @error('no_punggung') is-invalid @enderror form-control-sm" id="no_punggung" name="no_punggung" type="text" value="{{ $peserta->no_punggung }}">
                    @error('no_punggung')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
